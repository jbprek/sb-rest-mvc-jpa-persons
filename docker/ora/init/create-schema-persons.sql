...
BEGIN
    ...
    IF user_exists = 0 THEN
        ...
        EXECUTE IMMEDIATE 'GRANT CONNECT, RESOURCE, CREATE SESSION, DBA TO test_persons';
        DBMS_OUTPUT.PUT_LINE('User test_persons created successfully.');
    ELSE
        DBMS_OUTPUT.PUT_LINE('User test_persons already exists.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
